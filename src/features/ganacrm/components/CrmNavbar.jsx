...
const CrmNavbar = () => {
  ...
  return (
    <header className="bg-teal-600">
      <nav className="flex flex-wrap items-center justify-between max-w-5xl p-6 mx-auto">
        <Link
          to="/"
        ...
        {!show && (
          <div
            className={`flex-grow block w-full lg:flex lg:items-center lg:w-auto`}
          >
            <div className="text-sm lg:flex-grow lg:flex lg:gap-3 hover:opacity-80 hover:text-red-50">
              <NavLink
                style={({ isActive }) => ({
                  color: isActive ? 'red' : 'white',
                })}
                to="/crm/dashboard/leads"
                className="block mt-4 text-xl text-teal-200 lg:inline-block lg:mt-0 hover:text-white"
              >
                Leads
              </NavLink>
